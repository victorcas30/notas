...
const ConsultarUser = () => {
    ...
    return(
        ...
        <hr/>
        <button type="button" class="btn btn-primary" style={{ marginLeft: "auto" }}  onClick={abrirModalUser}>
        ...
        <table className="table table-secondary table-hover">
            ...
            users.map(user => {
                ...
                <tr key={idusuario}>
                    ...
                    <td>{usuario}</td>
                    <td>
                    <button type="button" class="btn btn-secondary" onClick={() => editarUser(idusuario)}>
