...
const ConsultarMaterias = () => {
    ...
    const { materias, setMaterias, cambiosMateria, setCambiosMateria, guardado, setGuardado, editado, setEditado, eliminado, vacio, setVacio  } = data;
    ...
    return(
        ...
        {vacio && <Alerts mensaje="Por favor, ingresa un nombre de Materia" tipo="danger" icono={<IconoText/>}  /> }
